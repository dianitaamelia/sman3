...
class Home extends MY_Controller {
   ...
   public function sambutan_kepala_sekolah() {
      if ($this->setting['cache_file'] == 'y') {
         $this->output->cache(5);
      }
      ...
      $this->data['kepsek'] = $this->db
         ...
         ->get('ptk')
         ->row_array();
      $this->data['content'] = 'themes/' . $this->setting['themes'] . '/sambutan_kepala_sekolah';
      $this->load->view('themes/' . $this->setting['themes'] . '/index', $this->data);
   }
   ...
   public function get_agenda_sekolah() {
      $start = substr($this->input->get("start"), 0, 10);
      $end = substr($this->input->get("end"), 0, 10);
      $data = [];
