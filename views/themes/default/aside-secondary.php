...
<aside id="aside-secondary">
	 ...
	 <div class="widget-title">
		  <h4><span class="ja ji"><?=$menu['sambutan_kepala_sekolah'] == '' ? 'SAMBUTAN KEPSEK' : $menu['sambutan_kepala_sekolah'];?></span> <i class="fa fa-microphone"></i></h4>
	 </div>
	 <div class="widget">
		  <ul class="post-list">
				<li class="clearfix" style="padding:0;">
				    <div class="sambut">
					 ...
					 <p><?=strip_tags(substr($this->setting['sambutan_kepala_sekolah'], 0, 233));?>...</p>
					 <p><a class="samkep" href="<?=site_url('home/sambutan_kepala_sekolah');?>">Selengkapnya..<i class="fa fa-angle-right"></i></a></p>
				</li>
		  </ul>
	 </div>
	 <?php } ?>
