...
<aside id="aside-secondary">
	 ...
	 <div class="widget-title">
		  <h4><i class="icon-comment icon-white"></i> <?=$menu['sambutan_kepala_sekolah'] == '' ? 'SAMBUTAN KEPALA SEKOLAH' : $menu['sambutan_kepala_sekolah'];?></h4>
	 </div>
	 <div class="widget">
		  <ul class="post-list">
				<li class="clearfix" style="padding:0;text-align:justify;">
					 ...
					 <?php } ?>
					 <?=strip_tags(substr($this->setting['sambutan_kepala_sekolah'], 0, 500));?>...
					 <a href="<?=site_url('home/sambutan_kepala_sekolah');?>">[selengkapnya]</a>
				</li>
		  </ul>
	 </div>
	 <?php } ?>
