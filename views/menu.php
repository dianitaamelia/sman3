...
<section class="content">
    ...
    <?=form_open($action, array('role' => 'form', 'class'=>'form-horizontal form-bordered'));?>
        <div class="form-body">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Direktori Guru</label>
                <div class="col-md-9">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Direktori Alumni</label>
                <div class="col-md-9">
                    <input required type="text" class="form-control" name="direktori_alumni" value="<?=$set_menu['direktori_alumni']?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Sambutan Kepala Sekolah</label>
                <div class="col-md-9">
